...
class ReturnVoucher(models.Model):
    ...
    voucher_line_ids = fields.One2many(comodel_name="return.voucher.line", inverse_name="return_id")
...
class ReturnVoucherLine(models.Model):
    _name = 'return.voucher.line'
    return_id = fields.Many2one(comodel_name="return.voucher", string="Return", )
